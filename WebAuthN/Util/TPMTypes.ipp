...
//  webauthn-cpp
//
//  Created by Flaviu Pasca on 03/24/23.
//  flaviup on gmail com
//

#ifndef WEBAUTHN_UTIL_TPM_TYPES_IPP
#define WEBAUTHN_UTIL_TPM_TYPES_IPP
...
#endif
#ifndef ALG_SHA3_256
#define ALG_SHA3_256 0
#endif
#ifndef ALG_SHA3_384
#define ALG_SHA3_384 0
#endif
#ifndef ALG_SHA3_512
#define ALG_SHA3_512 0
#endif
#ifndef ALG_SHA512
#define ALG_SHA512 0
#endif
#ifndef ALG_SM3_256
#define ALG_SM3_256 0
#endif
...
ByteArrayToUint32(
    ...
    return (uint32_t)((((((uint32_t)a[0] << 8) + a[1]) << 8) + (uint32_t)a[2]) << 8) + a[3];
}
...
ByteArrayToUint64(
    ...
    return (((uint64_t)BYTE_ARRAY_TO_UINT32(a)) << 32) + BYTE_ARRAY_TO_UINT32(&a[4]);
}
...
#define TYPE_OF_TPM_ALG_ID              uint16_t
...
#define TYPE_OF_TPM_ECC_CURVE uint16_t
...
#define ECC_NIST_P192                   1 /* libtpms enabled */
#endif
#ifndef ECC_NIST_P224
#define ECC_NIST_P224                   1 /* libtpms enabled */
#endif
#ifndef ECC_NIST_P256
#define ECC_NIST_P256                   1
#endif
#ifndef ECC_NIST_P384
#define ECC_NIST_P384                   1
#endif
#ifndef ECC_NIST_P521
#define ECC_NIST_P521                   1 /* libtpms enabled */
#endif
#ifndef ECC_BN_P256
#define ECC_BN_P256                     1
#endif
#ifndef ECC_BN_P638
#define ECC_BN_P638                     1 /* libtpms enabled */
#endif
#ifndef ECC_SM2_P256
#define ECC_SM2_P256                    1 /* libtpms enabled */
#endif
...
#define TYPE_OF_TPM_CC                      uint32_t
...
#define TYPE_OF_TPM_ALGORITHM_ID uint32_t
        typedef uint32_t            TPM_MODIFIER_INDICATOR;
#define TYPE_OF_TPM_MODIFIER_INDICATOR uint32_t
        typedef uint32_t            TPM_AUTHORIZATION_SIZE;
#define TYPE_OF_TPM_AUTHORIZATION_SIZE uint32_t
        typedef uint16_t            TPM_PARAMETER_SIZE;
#define TYPE_OF_TPM_PARAMETER_SIZE uint32_t
        typedef uint16_t            TPM_KEY_SIZE;
#define TYPE_OF_TPM_KEY_SIZE    uint16_t
        typedef uint16_t            TPM_KEY_BITS;
#define TYPE_OF_TPM_KEY_BITS    uint16_t

        /* Table 2:6 - Definition of TPM_SPEC Constants */
        typedef uint32_t        TPM_SPEC;
#define TYPE_OF_TPM_SPEC        uint32_t
...
#define TPM_SPEC_DAY_OF_YEAR    (TPM_SPEC)(SPEC_DAY_OF_YEAR)
        ...
        typedef uint32_t        TPM_CONSTANTS32;
#define TYPE_OF_TPM_CONSTANTS32 uint32_t
...
#define TYPE_OF_TPM_RC              uint32_t
...
#define TYPE_OF_TPM_CLOCK_ADJUST   uint8_t
...
#define TYPE_OF_TPM_EO        uint16_t
...
#define TYPE_OF_TPM_ST                 uint16_t
...
#define TYPE_OF_TPM_CAP            uint32_t
...
#define TYPE_OF_TPM_PT                uint32_t
...
#define TYPE_OF_TPM_PT_PCR         uint32_t
...
#define TYPE_OF_TPM_PS           uint32_t
...
#define TYPE_OF_TPM_HANDLE uint32_t
...
#define  HR_TRANSIENT            (TPM_HC)(((uint32_t)TPM_HT_TRANSIENT<<HR_SHIFT))  /* libtpms cast (ubsan) */
#define  HR_PERSISTENT           (TPM_HC)(((uint32_t)TPM_HT_PERSISTENT<<HR_SHIFT)) /* libtpms cast (ubsan) */
...
#define TYPE_OF_TPMA_ALGORITHM       uint32_t
#define TPMA_ALGORITHM_TO_UINT32(a)  (*((uint32_t *)&(a)))
...
#define BYTE_ARRAY_TO_TPMA_ALGORITHM(i, a)              \
    {uint32_t x = BYTE_ARRAY_TO_UINT32(a);              \
...
#define TYPE_OF_TPMA_OBJECT uint32_t
#define TPMA_OBJECT_TO_UINT32(a)     (*((uint32_t *)&(a)))
...
#define BYTE_ARRAY_TO_TPMA_OBJECT(i, a)                 \
    { uint32_t x = BYTE_ARRAY_TO_UINT32(a); i = UINT32_TO_TPMA_OBJECT(x); }
...
#define TYPE_OF_TPMA_SESSION         uint8_t
#define TPMA_SESSION_TO_UINT8(a)     (*((uint8_t *)&(a)))
...
#define BYTE_ARRAY_TO_TPMA_SESSION(i, a)                                           \
            { uint8_t x = BYTE_ARRAY_TO_UINT8(a); i = UINT8_TO_TPMA_SESSION(x); }
#if USE_BIT_FIELD_STRUCTURES
...
#define TYPE_OF_TPMA_LOCALITY        uint8_t
#define TPMA_LOCALITY_TO_UINT8(a)    (*((uint8_t *)&(a)))
...
#define BYTE_ARRAY_TO_TPMA_LOCALITY(i, a)                                          \
            { uint8_t x = BYTE_ARRAY_TO_UINT8(a); i = UINT8_TO_TPMA_LOCALITY(x); }
#if USE_BIT_FIELD_STRUCTURES
...
#define TYPE_OF_TPMA_PERMANENT       uint32_t
#define TPMA_PERMANENT_TO_UINT32(a)  (*((uint32_t *)&(a)))
...
#define TYPE_OF_TPMA_STARTUP_CLEAR  uint32_t
#define TPMA_STARTUP_CLEAR_TO_UINT32(a)  (*((uint32_t *)&(a)))
...
#define TYPE_OF_TPMA_MEMORY          uint32_t
#define TPMA_MEMORY_TO_UINT32(a)     (*((uint32_t *)&(a)))
...
#define BYTE_ARRAY_TO_TPMA_MEMORY(i, a)                                            \
            { uint32_t x = BYTE_ARRAY_TO_UINT32(a); i = UINT32_TO_TPMA_MEMORY(x); }
#if USE_BIT_FIELD_STRUCTURES
...
#define TYPE_OF_TPMA_CC          uint32_t
#define TPMA_CC_TO_UINT32(a)     (*((uint32_t *)&(a)))
...
#define BYTE_ARRAY_TO_TPMA_CC(i, a)                                                \
            { uint32_t x = BYTE_ARRAY_TO_UINT32(a); i = UINT32_TO_TPMA_CC(x); }
#if USE_BIT_FIELD_STRUCTURES
...
#define TYPE_OF_TPMA_MODES       uint32_t
#define TPMA_MODES_TO_UINT32(a)  (*((uint32_t *)&(a)))
...
#define BYTE_ARRAY_TO_TPMA_MODES(i, a)                                             \
            { uint32_t x = BYTE_ARRAY_TO_UINT32(a); i = UINT32_TO_TPMA_MODES(x); }
#if USE_BIT_FIELD_STRUCTURES
...
#define TYPE_OF_TPMA_X509_KEY_USAGE          uint32_t
#define TPMA_X509_KEY_USAGE_TO_UINT32(a)     (*((uint32_t *)&(a)))
...
#define TYPE_OF_TPMA_ACT         uint32_t
#define TPMA_ACT_TO_UINT32(a)    (*((uint32_t *)&(a)))
...
#define BYTE_ARRAY_TO_TPMA_ACT(i, a)                    \
    { uint32_t x = BYTE_ARRAY_TO_UINT32(a); i = UINT32_TO_TPMA_ACT(x); }
#if USE_BIT_FIELD_STRUCTURES
...
#endif /* WEBAUTHN_UTIL_TPM_TYPES_IPP */